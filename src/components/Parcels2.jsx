                ...
                {sortedStatuses.map((status, index) => {
                  ...
                  return (
                    <div className="status-item" key={index}>
                      ...
                      <div className="status-text">
                      {status.statusText !== "По филиалам" && (
                        <p>{status.statusText}</p>
                      )}
                        {/* Добавляем информацию о филиале, если статус "По филиалам" */}
                        {status.statusText === "По филиалам" && (
                          <div className="filial-info">
                            <p>{status.statusText} - {bookmark.toFilial ? 
                              `${bookmark.toFilial} (${bookmark.toFilialAdress})` 
                              : 'Нет информации о филиале'}</p>
                          </div>
                        )}
